...
lv_obj_t * settings_item_create(lv_obj_t * parent, const void * icon, const char * settings_name)
{
    ...
    lv_obj_add_style(lv_obj_0, &style_flex, 0);
    ...
    lv_label_set_text(lv_label_0, settings_name);
