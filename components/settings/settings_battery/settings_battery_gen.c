...
#include "settings_battery_gen.h"
#include "../../../helios_ui.h"
...
lv_obj_t * settings_battery_create(lv_obj_t * parent)
{
    ...
    if (helios_ui_check_target(HELIOS_UI_TARGET_ALL)) {
        ...
        lv_obj_set_name_static(wd_list_0, "settings_battery_#");
        ...
        lv_label_set_translation_tag(hs_text_normal_0, "battery");
        ...
        hs_bar_create(hs_card_1, "Brightness", "battery", &sb_battery_percent);

        hs_info_sb_create(hs_card_1, "Label", "voltage", &sb_battery_voltage, "%.2fV");

        hs_info_sb_create(hs_card_1, "Label", "temperature", &sb_battery_temp, "%.1f°");

        hs_line_create(hs_card_1);

        hs_info_sb_create(hs_card_1, "Label", "usage", &sb_battery_usage, "%s");
