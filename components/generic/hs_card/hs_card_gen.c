...
lv_obj_t * hs_card_create(lv_obj_t * parent)
{
    ...
    lv_obj_set_name_static(lv_obj_0, "hs_card_#");
    lv_obj_set_flag(lv_obj_0, LV_OBJ_FLAG_OVERFLOW_VISIBLE, true);
