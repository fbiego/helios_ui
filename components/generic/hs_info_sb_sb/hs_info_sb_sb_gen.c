...
lv_obj_t * hs_info_sb_sb_create(lv_obj_t * parent, lv_subject_t * label, lv_subject_t * info)
{
    ...
    if (helios_ui_check_target(HELIOS_UI_TARGET_ALL)) {
        ...
        lv_obj_set_name_static(lv_obj_0, "hs_info_sb_sb_#");
        ...
        lv_label_bind_text(hs_text_normal_0, label, NULL);
        ...
        lv_label_bind_text(hs_text_normal_1, info, NULL);
